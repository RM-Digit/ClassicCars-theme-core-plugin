...
<div class="vehica-car-form">
    <div class="vehica-car-form__inner">
        ...
        <vehica-car-form
                ...
                redirect-url="<?php echo esc_url(\Vehica\Widgets\General\PanelGeneralWidget::getCarListPageUrl()); ?>"
                        ...
                        <div class="vehica-car-form__save-submit__save-changes">
                            ...
                            >
                                ...
                                <span class="vehica-button__text-disabled"><i
                                            class="fas fa-file-import"></i> <?php echo esc_html(vehicaApp('uploading_files_please_wait_string')); ?></span>
