        ...
        <div slot-scope="userPackages">
            <vehica-packages-view
                <?php if (vehicaApp('woocommerce_mode')) : ?>
                    initial-view="select"
                <?php else : ?>
                    initial-view="<?php echo esc_attr(vehicaApp('current_user')->hasPackages() ? 'buy' : 'buy'); ?>"
                <?php endif; ?>
            >
                <div
                                        ...
                                        <?php foreach (vehicaApp('valid_payment_packages') as $vehicaPaymentPackage) :
                                            ...
                                            >
                                                <div class="vehica-package__left">
                                                    ...
                                                    <?php endif; ?>
                                                    <div class="vehica-package__name"><?php echo esc_html($vehicaPaymentPackage->getName()); ?></div>
                                                    <div class="vehica-package__price"><?php echo esc_html($vehicaPaymentPackage->getDisplayPrice()); ?></div>
                                                </div>
                                            ...
                                            <div
                                                    v-if="buyPackage.showPaymentMethods && buyPackage.packageKey === '<?php echo esc_attr($vehicaPaymentPackage->getKey()); ?>'"
                                                    ...
                                                    <?php if (vehicaApp('settings_config')->isStripeEnabled() && \Vehica\Core\BaseCurrency::getSelected()) : ?>
                                                        <div>
                                                            ...
                                                            <vehica-stripe
                                                                    ...
                                                                    :package-key="buyPackage.packageKey"
                                                            ...
                                                            >
                                                                <div slot-scope="stripeProps"
                                                                    ...
                                                                    <form id="vehica-payment-form">
                                                                        ...
                                                                        >
                                                                            <span id="button-text"><?php echo esc_html(vehicaApp('pay_now_string')); ?> (<?php echo esc_html($vehicaPaymentPackage->getDisplayPrice()); ?>)</span>
                                                                        </button>
                                    ...
                                    >
                                        ...
                                        <div class="vehica-package__right">
                                            <div class="vehica-package__desc">
                                                ...
                                                <div v-if="package.featured_expire > 0"
