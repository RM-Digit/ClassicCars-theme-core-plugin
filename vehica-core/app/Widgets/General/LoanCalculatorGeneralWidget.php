    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => 'If you need dynamic initial rate (e.g. lower % for 24+ months) please read <a target="_blank" href="https://support.vehica.com/knowledgebase/php-customization-loan-calculator-the-interest-rate-change-when-user-change-number-of-months/">this article</a>.',
                'type' => Controls_Manager::TEXT,
                'default' => 5
            ]
        );
