...
/**
 * Class PostsPostArchiveWidget
 * @package Vehica\Widgets\Post\Archive
 */
class PostsPostArchiveWidget extends PostArchiveWidget
{
    use PostsPartialWidget;

    const NAME = 'vehica_posts_post_archive_widget';
    const TEMPLATE = 'post/archive/posts';
    ...
    {
        return esc_html__('Blog Grid', 'vehica-core');
    }
    ...
    {
        return $this->getUrl() . '?pagination=' . $page;
    }
