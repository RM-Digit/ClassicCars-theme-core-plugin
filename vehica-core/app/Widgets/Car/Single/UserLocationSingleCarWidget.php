...
/**
 * Class UserLocationSingleCarWidget
 * @package Vehica\Widgets\Car\Single
 */
class UserLocationSingleCarWidget extends SingleCarWidget
{
    const NAME = 'vehica_user_location_single_car_widget';
    const TEMPLATE = 'car/single/user_location';
    ...
    {
        return esc_html__('Listing Owner Location', 'vehica-core');
    }
