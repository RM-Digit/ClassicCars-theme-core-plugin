        ...
        <div class="vehica-section__left__inner">
            ...
            <div style="margin-top:10px;">
                <a
                        ...
                        href="https://support.vehica.com/knowledgebase/logo-how-to-change-logo-image-and-its-size/"
                >
            ...
            <div class="vehica-field">
                ...
                <div class="vehica-field">
                    ...
                    <a
                            ...
                            href="https://support.vehica.com/knowledgebase/private-message-system/">
                        <i class="fas fa-info-circle"></i>
        ...
        <div class="vehica-section__left__inner">
            ...
            <div style="margin-top:10px;">
                <a
                        ...
                        target="_blank"
                        style="margin: 5px 0 20px 0;"
                        href="https://support.vehica.com/knowledgebase/how-to-customize-header-menu-colors-font-size-etc/">
                    <i class="fas fa-info-circle"></i>
        ...
        <div class="vehica-section__left__inner">
            ...
            <div>
                <a
                        class="vehica-doc-link vehica-doc-link--full-width"
                        target="_blank"
                        href="https://support.vehica.com/knowledgebase/how-to-edit-footer/">
                    <i class="fas fa-info-circle"></i>
        ...
        <div class="vehica-section__left__inner">
            ...
            <div><?php esc_html_e('You have access to 800+ Google Fonts. You can also use any custom fonts if you wish', 'vehica-core'); ?>
                <a class="vehica-doc-link-solo" target="_blank"
                   href="https://support.vehica.com/knowledgebase/how-to-use-fonts-other-than-google-fonts/">
        ...
        <div class="vehica-section__right__inner">
                    ...
                    >
                        <?php foreach (vehicaApp('simple_text_car_fields') as $simpleTextField) :
                            ...
                            <option
                                ...
                                <?php if (in_array($simpleTextField->getId(), vehicaApp('settings_config')->getAutoCarTitleFieldIds(), true)) : ?>
                                    selected
                                <?php endif; ?>
                            >
            ...
            <div class="vehica-field">
                ...
                <label for="<?php echo esc_attr(\Vehica\Model\Post\Config\Setting::ENABLE_CUSTOM_TEMPLATES); ?>">
                    ...
                    <a href="https://support.vehica.com/knowledgebase/allow-to-assign-different-templates-to-specific-types-of-listings-e-g-motorcycles-sold-or-any-other/"
                       target="_blank"
                ...
                <div class="vehica-field__col-1">
                    <label for="<?php echo esc_attr(\Vehica\Model\Post\Config\Setting::FACEBOOK_API); ?>">
                        ...
                        <a class="vehica-doc-link-solo"
                           href="https://support.vehica.com/knowledgebase/facebook-share-button-configuration-adding-facebook-api-key-free-that-allow-to-display-featured-image-correctly/">
                            <?php esc_html_e('- click here to read more', 'vehica-core'); ?>
                        </a>
                    </label>
                </div>
        ...
        <div slot-scope="currenciesProps">
            ...
            <div>
                <a
                        class="vehica-doc-link vehica-doc-link--full-width"
                        target="_blank"
                        href="https://support.vehica.com/knowledgebase/multi-currency/">
                    <i class="fas fa-info-circle"></i>
